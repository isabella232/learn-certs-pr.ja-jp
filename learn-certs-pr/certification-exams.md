...
Microsoft Office Specialist (MOS) 試験、およびその他のアカデミック アウトレットを通じて実施される試験は、[Certiport からご登録](https://www.certiport.com/portal/Pages/Registration.aspx) ください。
...
認定資格パスにおけるベータ試験の合格は、受験生の認定資格に反映されます。最終版の試験を再受験する必要はありません。ベータ試験の割引プログラムを通じてベータ試験を受けることで取得した 25％ の割引を使って、1 年以内に別の試験を受けてください。

ベータ試験に合格しなかった場合、ベータ試験を再受験することはできません。当該試験の正常な完了を必要とする認定資格の取得に関心がある場合は、通常の費用で試験を再受験できるようになるまで待つか、割引プログラムによるベータ試験の受験で取得した 25％ 割引を適用することができます。
