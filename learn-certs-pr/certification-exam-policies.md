...
1. Microsoft 認定資格試験の再受験についての基本方針
    1. 初回の試験で合格スコアを獲得できなかった受験者は、24～30 時間たたないと再受験できません。この期間が過ぎると、受験者は [certification dashboard](https://aka.ms/certdashboard) にログオンして、試験を再予約できるようになります。
    2. 2 回目の試験で合格スコアを獲得できなかった受験者は、14 日以上たたないと 3 回目の試験を受けられません。
    3. 14 日間の待機期間は、4 回目および 5 回目の再受験にも適用されます。
    4. 受験者は、同一の試験を 1 年間 (12 か月間) に 5 回以上受けることはできません。この 12 か月の期間は、最初の受験日から開始されます。受験者は、その日から起算して 12 か月後に、再び試験を受けることができます。1 年間に 5 回以上特定の試験を受ける、または待機期間を免除するには、受験者が Microsoft にリクエストを提出し、Microsoft から事前に許可を得る必要があります。リクエストの送信先は [mlsecure@microsoft.com](mailto:mlsecure@microsoft.com) です。これらのリクエストには次の情報を含みます:
        - 受験者 ID
        - 姓/名
        - 受験者 ID に関連付けられたメール
        - 試験登録 ID
    ...
    **以下のシナリオでは、試験の再受験の例外が認められます。**
      - ラボの故障による失敗
      - インターネット接続の問題による失敗
      - 機器の故障による失敗
      - ピアソン VUE ケース番号を含むリクエスト

    **以下のシナリオでは、試験の再受験の例外は認められません。**
      - 受験者の準備、知識、スキル、または能力の欠如による失敗
      - ピアソン VUE ケース番号を含まないリクエスト

    試験の再受験の例外リクエストの送信先は [mlsecure@microsoft.com](mailto:mlsecure@microsoft.com) です。これらのリクエストには次の情報を含みます:
      - 受験者 ID
      - 姓/名
      - 受験者 ID に関連付けられたメール
      - 試験登録 ID
...
ピアソン VUE は、スロベニアのプライバシー法により、スロベニアに居住する方やスロベニア国籍を有する方に対して、オンライン監督試験を実施することができません。当該受験者は、テスト センターで試験を受けることができます。
...
ベータ プロセスに参加していただいた事への感謝を込めて、試験が開始されてから約 6 週間後に、試験提供プロバイダから 25％ のディスカウント バウチャーをお贈り致します。これらのバウチャーは 試験提供プロバイダが提供しており、試験への登録時に使用した Eメール アドレス宛てに送信されます。試験実施日から 6 週間以内に 25% の割引券が届かない場合は、試験提供プロバイダのカスタマー サポートにお問い合わせください。
...
- ステップ 2: サインイン [Microsoft Certification Dashboard](https://aka.ms/certdashboard)
...
- 詳細については、以下を参照してください: [Microsoft Exam and Certification Badges](/learn/certifications/badges)
...
Microsoft の認定試験が有効で、関連性のあるものになるように、可能な限りお手伝いをさせていただきますので、ご興味をお持ちいただきありがとうございます。
...
<div><div style='color&#58; red;'><font color='red'>Microsoft では、予定されている予約時間の24時間前までに試験をキャンセルする場合に限り、リスケジュールとキャンセル料を一時的に免除しています。</font></div></div>
...
スケジュールされた試験予約の再スケジュールまたはキャンセルは、[Certification Dashboard](https://aka.ms/certdashboard)から実行できます。
...
Microsoft 認定資格試験は、さまざまな言語で提供されています。母語ではなく、英語で試験を受験する必要がある受験者は、時間の延長をリクエストできます。追加時間の承認は状況に応じて行われ、試験の前にリクエストする必要があります。これは、[accommodations process](/learn/certifications/certification-exam-policies#special-accommodations-when-taking-exams) を通じてリクエストする必要があります。

**障害をお持ちの方に対応するために、どのような設備が提供されていますか?**

Microsoft では、障害をお持ちの方を含めすべての人が試験を受験できるように努めています。利用可能な宿泊施設のリストについては、[accommodations section](/learn/certifications/certification-exam-policies#special-accommodations-when-taking-exams) にアクセスしてください。
...
その他のご意見は、[Certification Support](https://aka.ms/mcpforum) までご連絡ください。
...
ラボでは、従来の項目タイプよりも採点時間が長くなります。ラボは試験の終了時に出てくるため、すぐに結果が得られない場合があります。採点を受け取るまで 30 分以上かかる場合があります。採点報告を待つ必要はありません。それは自動的に認定データベースに回され、 MC ダッシュボードに表示されます。これは、試験の実施から 24 時間以内に行われます。表示されない場合、[Certification Support](https://aka.ms/mcpforum) までお問い合わせください。
