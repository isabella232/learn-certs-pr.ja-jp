...
これは快適な補助手段と見なされ、事前の承認は**不要**です。Test Center のスタッフによる目視検査時に、試験会場での補助器具の使用が許可されます。目視検査は[注記]がない限り、アイテム (または候補者)に直接触れることなく、アイテムを削除するように候補者に依頼することなく、アイテムを調べることによって行われます (https://home.pearsonvue.com/test-taker/Test-accommodations/Comfort-aids.aspx)。 
