...
* **[Microsoft Volume Licensing for Software Assurance](/partner-center/software-assurance-lp)**。既存のソフトウェアア シュアランスで特定のソフトウェア アシュアランス eラーニングおよびインストラクター主導のトレーニングを利用可能にする、費用対効果の高いプログラム。
...
* Microsoft Imagine Academy (対象組織向け)
  ...
  Microsoftイマジンアカデミー（MSIA）プログラムは、技術コース、教育リソース、および需要の高い労働力またはキャリアスキルに合わせた関連するメリットを提供するスキル特典です。包括的な学習過程とカリキュラムにより、受講者は業界で認められた認定と雇用を手に入れることができます。教材には、Microsoftオフィススペシャリスト、Microsoftテクノロジーアソシエイト、およびMicrosoft基礎認定の準備のためのカリキュラムが含まれています。
...
* 教育機関向けの Microsoft 認定資格試験パック
  ...
  Microsoftオフィススペシャリスト（MOS）、Microsoftテクノロジーアソシエイト（MTA）、ファンダメンタルズ、Microsoft認定プロフェッショナル認定など、Microsoft認定資格を取得するための試験クラスとサイトパックにお申し込み頂けます。認定資格試験クラスおよびサイトパックには、1年間で使用できる特定数の試験バウチャーが含まれています。高校でも、2年制大学でも、4年制大学でも、独自のニーズに合わせてさまざまな認定資格を調整することが可能です。
  ...
  Microsoft認定資格試験パックは、次のMicrosoft アカデミックボリュームライセンスプログラムを通じて注文できます。

  EES（Enrollment for Education Solutions）、School、およびOVS-ES（Open Value Subscription – Education Enrollmentサブスクリプション）ボリュームライセンスサブスクリプション。 詳細については、アカデミックライセンスリセラーに問い合わせるか、[業界向けマイクロソフトライセンスプログラム](https://www.microsoft.com/licensing/licensing-options/for-industries.aspx)ページにアクセスしてください。
...
以下の質問は、特にMicrosoft のボリュームライセンス トレーニングおよび認定資格ソリューションに対応しています。Microsoft 認定資格または試験に関する一般的な質問への回答については、[certification overview](/learn/certifications/) または [exam policies and FAQ](/learn/certifications/certification-exam-policies) ページにアクセスしてください。
...
各試験には準備資料が用意されています。[new exams list](/learn/certifications/browse/?resource_type=examination) から試験を選択し、試験で利用可能な準備オプションを探します。
