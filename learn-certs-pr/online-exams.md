...
役割ベースのMicrosoft CertificationまたはPearson VUEオンラインでの基礎試験を、ご自宅やオフィスで快適に受験して頂くことができます。オンライン監督試験の配信は、ウェブカメラとマイクを介して監督が試験中に監視することにより、試験結果の整合性を維持します。Pearson VUEを通じてオンライン監督試験を受けることに興味をお持ちで、登録前により細く理解されたい方は、このページに重要な詳細が含まれています。オンラインの監督付き試験の受験について詳しくは、下記動画をご覧ください。 （このセクションでは、Certiportが提供する試験については説明しておりません。）
<br/>
